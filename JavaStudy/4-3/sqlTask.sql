...
-- [回答]
select tbl2.store_name,tbl3.goods_name,quantity 
from stock_table tbl1
join store_table tbl2 on tbl1.store_code=tbl2.store_code
join goods_table tbl3 on tbl1.goods_code=tbl3.goods_code; 
...
values('M001','マフラー',4500,'2020-12-13');
