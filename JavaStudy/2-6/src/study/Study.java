...
public class Study {
    ...
    public static void main(String args[]) {
       ...
       System.out.println(now);
        ...
        // その理由をコメントへ記述してください。
        // [ここへ記述](Calendar.MONTH) + 1で想定していない値が出ることはないのではないかと文屋さんに質問したところ、旧
        //バージョンでは問題は起こっていたが現在のバージョンでは特に問題がないとのことでした。そもそも0～11の値しか
        //入らないMONTHに1を足しても1～12以外の正常でない値が出ることはあり得ないと思うのですがこの理解であっていますでしょうか。
