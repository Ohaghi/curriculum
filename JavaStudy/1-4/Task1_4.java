...
public class Task1_4 {
    ...
    private static final String accountName = "alice";
    private static final String accountPass = "pass";
    ...
    public static void main(String[] args) {
        ...
        // ② 名前が「 alice 」、パスワードが「 pass 」であった場合、「 ログイン成功です 」と出力してください。
         if(name==accountName && pass==accountPass){
             System.out.println("ログイン成功です");
         }

        // ③ 名前のみ正しい場合、「 パスワードに誤りがあります。 」と出力してください。
         else if(name==accountName && pass!=accountPass)
